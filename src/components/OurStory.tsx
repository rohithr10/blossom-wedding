...
const timeline = [
  {
    ...
    title: 'First Meeting',
    date: '2023',
    description: 'Our paths crossed for the first time, and we knew there was something special between us.'
  },
  {
    icon: Heart,
    title: 'Engagement',
    date: 'January 11, 2026',
    description: 'Surrounded by family and friends, we committed to spend our lives together in God\'s blessing.'
  },
  {
    icon: Church,
    title: 'The Wedding',
    date: 'January 12, 2026',
    description: 'We unite in holy matrimony, beginning our journey as husband and wife.'
  }
];
...
const OurStory = () => {
  ...
  return (
    <section className="py-20 px-4 section-story relative overflow-hidden" id="story">
      {/* Decorative cross */}
      <motion.div
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-primary font-semibold">— 1 Corinthians 13:4–7</span>
          </motion.p>
        </motion.div>
